...
public final class AppRawFiles {
    ...
    private void loadSync(ThreadTask.ProgressCallback<LottieComposition> progressCallback) {
        ...
        ResourceMapping[] mappings = {
                ...
                new ResourceMapping(R.raw.animation_audio_visualizing_v1, comp -> audioVisualizingV1Composition = comp),
                new ResourceMapping(R.raw.animation_audio_visualizing, comp -> audioVisualizingComposition = comp),
     ...
     * This animation is typically used when media has been successfully scanned and is available for download.
     *
