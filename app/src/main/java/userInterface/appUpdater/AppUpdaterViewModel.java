    ...
    public static class DownloadStatus {
        ...
        public static DownloadStatus pending() {
            return new DownloadStatus(
                    State.PENDING, (short) 0, 0L, 0L, null, null
            );
		}
        ...
        public static DownloadStatus downloading(short progress,
                                                 ...
                                                 long totalFileSize) {
            return new DownloadStatus(
                    State.DOWNLOADING, progress, downloadedByte,
        ...
        public static DownloadStatus error(String error) {
            return new DownloadStatus(
                    State.ERROR, (short) 0, 0L, 0L, null, error
            );
		}

        public static DownloadStatus hashMismatch() {
            return new DownloadStatus(
                    State.HASH_MISMATCH, (short) 0,
                    0L, 0L, null, "Hash verification failed."
            );
		}
