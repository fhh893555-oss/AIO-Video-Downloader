...
/**
 * Utility class providing categorized collections of common file extensions.
 * <p>
 * This class contains predefined arrays and lists of file extensions for various
 * categories, including archives, executable programs, multimedia (video and music),
 * documents, and images. It is primarily used for file filtering, type
 * identification, and validation of downloadable content.
 * </p>
 */
public final class FileExtensions {
    ...
    /**
     * A collection of common file extensions associated with archive and compressed file formats.
     * Includes various compression types, disk images, and package formats.
     */
    ...
    /**
     * A collection of file extensions associated with executable programs, installers,
     * scripts, and system package formats across various operating systems.
     */
    public static final String[] PROGRAM_EXTENSIONS = {
    ...
    /**
     * An array of common file extensions for video files.
     */
    ...
    /**
     * A list of common video file extensions frequently encountered in online streaming
     * and web-based media delivery.
     */
    public static final List<String> ONLINE_VIDEO_FORMATS = Arrays.asList(
            "3gp", "avi", "divx", "f4v", "flv", "m2ts", "m3u8", "m4v", "mkv", "mov", "mp4", "mpd", "ogv",
            "rm", "vob", "webm", "wmv"
    );

    /**
     * A collection of common music and audio file extensions.
     */
    ...
    /**
     * A comprehensive list of file extensions associated with documents, including
     */
    ...
    /**
     * A list of common image file extensions, including raster, vector, and RAW camera formats.
     */
    ...
    /**
     * A comprehensive list of file extensions representing various downloadable formats.
     * This includes executables, documents, configuration files, images, videos, audio,
     * and archive formats commonly encountered during file transfers or downloads.
     */
    public static final String[] ALL_DOWNLOADABLE_FORMATS = {
            ...
            "swo", "swt", "java", "class", "xsd", "xsl", "xslt", "xsf", "svg",
